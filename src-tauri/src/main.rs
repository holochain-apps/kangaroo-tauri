...
const APP_NAME: &str = "hc-smoke-test-beta-2"; // name of the app. Can be changed without breaking your app.
const APP_ID: &str = "hc-smoke-test-beta-2"; // App id used to install your app in the Holochain conductor - can be the same as APP_NAME. Changing this means a breaking change to your app.
pub const WINDOW_TITLE: &str = "hc-smoke-test-beta-2"; // Title of the window
